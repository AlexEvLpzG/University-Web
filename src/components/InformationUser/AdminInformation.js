    ...
    return (
        <div className="container py-4">
            <div className="card bg-light">
                <div className="card-header">Detalle Administrador: { user.UserData.nombre + " " + user.UserData.ape_pat + " " + user.UserData.ape_mat }</div>
                ...
                <div className="card-body">
                    <ul className="list-group">
                        ...
                        <li className="list-group-item">Email: { user.UserData.email }</li>
                    </ul>
                </div>
            </div>
        </div>
